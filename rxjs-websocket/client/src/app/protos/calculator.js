...
export const Calculation = ($root.Calculation = (() => {
  ...
  Calculation.verify = function verify(message) {
    ...
    if (message.value1 != null && message.hasOwnProperty('value1'))
      if (typeof message.value1 !== 'number') return 'value1: number expected';
    if (message.value2 != null && message.hasOwnProperty('value2'))
      if (typeof message.value2 !== 'number') return 'value2: number expected';
  ...
  Calculation.fromObject = function fromObject(object) {
    if (object instanceof $root.Calculation) return object;
    let message = new $root.Calculation();
    if (object.value1 != null) message.value1 = Number(object.value1);
    if (object.value2 != null) message.value2 = Number(object.value2);
  ...
  Calculation.toObject = function toObject(message, options) {
    ...
    if (message.value1 != null && message.hasOwnProperty('value1'))
      object.value1 =
        options.json && !isFinite(message.value1) ? String(message.value1) : message.value1;
    if (message.value2 != null && message.hasOwnProperty('value2'))
      object.value2 =
        options.json && !isFinite(message.value2) ? String(message.value2) : message.value2;
    if (message.operation != null && message.hasOwnProperty('operation'))
      object.operation =
        options.enums === String
          ? $root.Calculation.Operation[message.operation] === undefined
            ? message.operation
            : $root.Calculation.Operation[message.operation]
          : message.operation;
    return object;
  };
...
export const Result = ($root.Result = (() => {
  ...
  Result.verify = function verify(message) {
    ...
    if (message.result != null && message.hasOwnProperty('result'))
      if (typeof message.result !== 'number') return 'result: number expected';
    return null;
  };
  ...
  Result.fromObject = function fromObject(object) {
    if (object instanceof $root.Result) return object;
    let message = new $root.Result();
    if (object.result != null) message.result = Number(object.result);
    return message;
  };
  ...
  Result.toObject = function toObject(message, options) {
    ...
    if (message.result != null && message.hasOwnProperty('result'))
      object.result =
        options.json && !isFinite(message.result) ? String(message.result) : message.result;
    return object;
  };
