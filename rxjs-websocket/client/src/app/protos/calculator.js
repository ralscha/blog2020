...
(function (global, factory) { /* global define, require, module */
  ...
  $root.Calculation = (function () {
     ...
     */
    Calculation.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length, message = new $root.Calculation();
    ...
    Calculation.fromObject = function fromObject(object) {
      if (object instanceof $root.Calculation)
        return object;
      var message = new $root.Calculation();
    ...
    Calculation.toObject = function toObject(message, options) {
      ...
      if (message.operation != null && message.hasOwnProperty("operation"))
        object.operation = options.enums === String ? $root.Calculation.Operation[message.operation] : message.operation;
      return object;
    };
