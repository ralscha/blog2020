...
export class AppComponent implements OnInit {
  ...
  markers: MarkerObject[] = [
    ...
    {
      option: {
        title: 'Balloon Flight Over Bagan',
        position: { lat: 21.1722165, lng: 94.8544872 },
      },
      videoId: '8epwUR6BBos',
      info:
        'The sunrise view from hot air balloon of thousands of temples ' +
    ...
    },
    {
      ...
      videoId: 'Y71gP5xJCAo',
      info:
        'January 2019 aerial footage of Ngwe Saung beach near Ngwe Saung Yacht Club and flight over ' +
    ...
    },
    {
      ...
      videoId: 'hDMuCbtgOgI',
      info:
        'The Golden Rock is one of the most important Buddhist sites in Myanmar. The huge bolder, ' +
    ...
    },
    {
      ...
      videoId: 'opAPwEN6bIQ',
      info:
        'The sacred Popa Taung Kalat monastery sits incredibly atop a huge rocky outcrop. 777 ' +
